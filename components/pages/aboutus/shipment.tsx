...
export default function AboutShipment() {
  return (
    <section className="bg-[#A93838] body-font ">
      <div className=" md:container px-4 md:px-60 py-4 md:py-12 md:mx-auto">
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 sm:w-1/4 w-1/2">
            <h2 className="text-[#FFFFFF] font-extrabold text-[25px] md:text-[30px]">
              25,000+
            </h2>
            <p className="leading-relaxed font-regular text-[13px] text-[#FFFFFF]">
              Shipment Delivered
            </p>
          </div>
          <div className="p-4 sm:w-1/4 w-1/2">
